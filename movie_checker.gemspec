...
Gem::Specification.new do |s|
  ...
  s.files       = ["bin/moviechecker.rb","config/environment.rb","lib/concerns/findable.rb","lib/command_Line_Interface.rb","lib/movie.rb","lib/scraper.rb","lib/stream.rb","CONTRIBUTING.md","Gemfile","Gemfile.Lock","LICENSE.md","README.md","Spec.md"]
